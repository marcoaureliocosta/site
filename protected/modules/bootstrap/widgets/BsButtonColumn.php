...
class BsButtonColumn extends CButtonColumn
{
    ...
    protected function renderDataCellContent($row,$data)
    {
        echo '<div class="btn-group">
              <button class="btn grey-cascade btn-xs dropdown-toggle" type="button" data-toggle="dropdown">
        ...
        //var_dump($this->buttons['updateStatus']);die('ij');
        foreach($this->buttons as $id=>$button)
        {
          //var_dump( $button);die('ij');
            echo '<li>';
    ...
    protected function renderButton($id, $button, $row, $data)
    {
        ...
        if ($icon = \bootstrap\helpers\BSArray::popValue('icon', $button, false)) {
             //echo '<li>';
            echo CHtml::link(BSHtml::icon($icon).' '.$label, $url, $options);
            //echo '</li>';
            //var_dump( $button);die('ij');
        } else {
